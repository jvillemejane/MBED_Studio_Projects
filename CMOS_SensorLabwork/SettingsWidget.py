...
class Setting_Widget_Int(QWidget):
    ...
    def __init__(self, settingLabel, minimumValue = 0, maximumValue = 100, initialisationValue = 50):
        ...
        self.slider.setStyleSheet("border-style: None")
        ...
        self.line.setStyleSheet("border-style: None; background-color: white; padding: 4px; color: black; border-style: solid; border-width: 1px;")
        ...
        self.labelValue.setStyleSheet("border-style: None")
